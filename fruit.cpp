...
class Fruit:public Mangoes{
	...
	public:
		void show(int num_mango,int num_apple){
	    	cout<<"the number of the mangoes in the basket is="<<num_mango<<endl;
			cout<<"the number of the apple in the basket is="<<num_apple<<endl;
...
int main(){
	int a,b;
	cout<<"enter the value of the apple"<<endl;
	cin>>a;
	cout<<"enter the value of the mangoes"<<endl;
	cin>>b;
